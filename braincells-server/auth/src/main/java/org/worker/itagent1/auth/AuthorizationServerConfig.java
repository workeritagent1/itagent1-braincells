...
//        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(new ClassPathResource("jwt.jks"), "dev123".toCharArray());
//        KeyPair keyPair = factory.getKeyPair("jwt", "dev123".toCharArray());
//        return keyPair;
//    }
//
//    /**
